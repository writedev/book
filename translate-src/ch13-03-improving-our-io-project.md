...
<Listing number="13-17" file-name="src/main.rs" caption="Reproduction de la fonction `Config::build` de la Liste 12-23">
...
<Listing number="13-18" file-name="src/main.rs" caption="Passage de la valeur de retour de `env::args` à `Config::build`">
...
<Listing number="13-19" file-name="src/main.rs" caption="Mise à jour de la signature de `Config::build` pour attendre un itérateur">
...
<Listing number="13-20" file-name="src/main.rs" caption="Changement du corps de `Config::build` pour utiliser des méthodes d'itérateur">
...
<Listing number="13-21" file-name="src/lib.rs" caption="L'implémentation de la fonction `search` de la Liste 12-19">
...
<Listing number="13-22" file-name="src/lib.rs" caption="Utilisation des méthodes d'adaptateurs d'itérateurs dans l'implémentation de la fonction `search`">
